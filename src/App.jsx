...
export default function App() {
  ...
  return (
    <div className="bg-background text-on-background font-body-md overflow-x-hidden min-h-screen">
      ...
      <main className="relative py-12" id="clan-chapters">
        {/* Chapter 1: The Bloom Family */}
        <section
          ref={addToRefs}
          className="relative py-16 px-gutter bg-surface transition-colors duration-500 hover:bg-surface-container-low opacity-0"
          id="bloom"
        >
          {/* Center Line Segment */}
          <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-[2px] bg-primary/40 z-10 hidden lg:block"></div>
          {/* Centered dot & year */}
          <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 z-20 hidden lg:flex flex-col items-center">
            <div className="w-5 h-5 rounded-full bg-secondary border-4 border-surface shadow-md"></div>
            <span className="font-display-lg text-sm text-primary mt-1 font-semibold">1982</span>
          </div>
        ...
        <section
          ref={addToRefs}
          className="relative py-16 px-gutter bg-surface-container-lowest transition-colors duration-500 hover:bg-surface-container opacity-0"
          id="miller"
        >
          {/* Center Line Segment */}
          <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-[2px] bg-primary/40 z-10 hidden lg:block"></div>
          ...
          <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 z-20 hidden lg:flex flex-col items-center">
            <div className="w-5 h-5 rounded-full bg-secondary border-4 border-surface shadow-md"></div>
            <span className="font-display-lg text-sm text-primary mt-1 font-semibold">1954</span>
          </div>

          <div className="max-w-container-max mx-auto relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
              {/* Left Side: Content */}
              <div className="space-y-6 lg:pr-12 lg:text-right">
                ...
                <p className="font-body-lg text-on-surface-variant leading-relaxed">
                  The Millers brought a spirit of curiosity and exploration to our archive. Travelers, artists, and scholars, their legacy is found in the letters sent from distant shores.
                </p>
                <div className="flex items-center space-x-3 text-outline lg:justify-end">
        ...
        >
          ...
          <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 z-20 hidden lg:flex flex-col items-center">
            <div className="w-5 h-5 rounded-full bg-secondary border-4 border-surface shadow-md"></div>
            <span className="font-display-lg text-sm text-primary mt-1 font-semibold">1910</span>
          </div>
        ...
        <section
          ref={addToRefs}
          className="relative py-16 px-gutter bg-surface-container-low transition-colors duration-500 hover:bg-surface opacity-0"
          id="vance"
        >
          {/* Center Line Segment */}
          <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-[2px] bg-primary/40 z-10 hidden lg:block"></div>
          ...
          <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 z-20 hidden lg:flex flex-col items-center">
            <div className="w-5 h-5 rounded-full bg-secondary border-4 border-surface shadow-md"></div>
            <span className="font-display-lg text-sm text-primary mt-1 font-semibold">1995</span>
          </div>
          ...
          <div className="max-w-container-max mx-auto relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
              ...
              <div className="space-y-6 lg:pr-12 lg:text-right">
                ...
                <p className="font-body-lg text-on-surface-variant leading-relaxed">
                  As the newest established branch, the Vances bring a contemporary energy to our heritage. Tech-savvy yet deeply traditional, they are the ones who pioneered this digital archive.
                </p>
                <div className="flex items-center space-x-3 text-outline lg:justify-end">
                  <span className="material-symbols-outlined">photo_library</span>
                  <span className="font-label-sm">Modern Archive</span>
                </div>
              </div>
